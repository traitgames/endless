...
export const SIMPLE_MOUNTAIN_TARGET_SHARE = 0.6;
export const SIMPLE_MOUNTAIN_SELECTOR_PRIMARY_SCALE = 0.00058;
export const SIMPLE_MOUNTAIN_SELECTOR_SECONDARY_SCALE = 0.00127;
export const SIMPLE_MOUNTAIN_SELECTOR_PRECHECK_MARGIN = 0.06;
export const SIMPLE_MOUNTAIN_SELECTOR_BLEND_HALF_WIDTH_METERS = BIOME_BLEND_HALF_WIDTH_METERS;
export const SIMPLE_MOUNTAIN_HIGH_ALTITUDE_FADE_METERS = 40;
